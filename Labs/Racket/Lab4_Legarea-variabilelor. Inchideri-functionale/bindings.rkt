...
(define (compute-length get-line-segment get-start-point get-end-point)
  (let* ((segm (get-line-segment))
         (start-p (get-start-point segm))  
         (end-p (get-end-point segm))
...
(define (distance p1 p2)
  (let* ((segm (cons p1 p2))
         (get-segm (lambda () segm))
         (get-start (lambda (segm) p1))
         (get-end (lambda (segm) p2)))
