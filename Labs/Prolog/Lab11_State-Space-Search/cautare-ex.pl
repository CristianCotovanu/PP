...
% problemă.
safeMisionari(NM, NC) :- once(NC =< NM ; NM == 0).
...
% dată.
parseState(state(Mal, NM_E, NC_E, NM_V, NC_V), Mal, NM_E, NC_E, NM_V, NC_V).
...
% S1.
next_state(misionari, S1, S2) :- parseState(S1, Mal, NM_Ein, NC_Ein, NM_Vin, NC_Vin),
                                Mal == est, 
                                boat(NM, NC),
                                NM =< NM_Ein, 
                                NC =< NC_Ein,
                                NM_Eout is NM_Ein - NM, 
                                NC_Eout is NC_Ein - NC,
                                NM_Vout is NM_Vin + NM, 
                                NC_Vout is NC_Vin + NC,
                                safeMisionari(NM_Eout, NC_Eout),
                                safeMisionari(NM_Vout, NC_Vout),
                                S2 = state(vest, NM_Eout, NC_Eout, NM_Vout, NC_Vout).
...
next_state(misionari, S1, S2) :- parseState(S1, Mal, NM_Ein, NC_Ein, NM_Vin, NC_Vin),
                                ...
                                safeMisionari(NM_Vout, NC_Vout),
                                safeMisionari(NM_Eout, NC_Eout),
                                S2 = state(est, NM_Eout, NC_Eout, NM_Vout, NC_Vout).
